...
class ImageParser:
    ...
    def convert_to_svg(self, image_filepath, target_width=800, target_height=800, scale_x=1.0, scale_y=1.0, min_paths=30, max_paths=120, min_contour_area=12, suffix='', method=3, apply_depthmap=True):
        ...
        processed_svg_filepath = self.process_svg(svg_filepath, depth_map, 1, 25)
    ...
    # ----- SVG Processing -----  
    @profile
    def process_svg(self, svg_filepath, depth_map, simplify=50, angle=15):
    ...
    @profile
    def simplify_svg(self, svg_filepath, removal_percentage=50, angle_threshold_deg=15):
        ...
        for i, polyline in enumerate(polylines):
            ...
            if points:
                ...
                simplified_points = self.rdp(parsed_points, epsilon)
