...
parser.add_argument("--style", default=None,
                    help="'+'-combinable styles: features, outline, shade, hair, landmarks, oneline, dynamic_grid, poisson_disk (e.g. features+hair+oneline).")
...
valid_styles = {"default", "features", "outline", "shade", "hair", "landmarks", "oneline", "dynamic_grid", "poisson_disk"}
if args.style:
